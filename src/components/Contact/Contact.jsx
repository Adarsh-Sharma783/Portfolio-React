...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_9rcgafk', 'template_7kex6r3', form.current, '1SbvBWDGyOMbAwrUI')
      .then((result) => {
          toast.success("Message sent to Adarsh");
      }, (error) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option" data-aos="fade-up" data-aos-anchor=".contact__container"  data-aos-duration='1600'>
            ...
            <h4>Email</h4>
            <h5>devduttadarsh6@gmail.com</h5>
            <a href="mailto:devduttadarsh6@gmail.com" target='_blank'  rel="noreferrer">Email me</a>
          </article>
          ...
          <article className="contact__option" data-aos="fade-up" data-aos-anchor=".contact__container"  data-aos-duration='1300'>
            ...
            <h4>Linkedin</h4>
            <h5>adarsh-sharma06</h5>
            <a href="https://www.linkedin.com/in/adarsh-sharma06/" target='_blank'  rel="noreferrer">Let's connect</a>
          </article>
          ...
          <article className="contact__option" data-aos="fade-up" data-aos-anchor=".contact__container"  data-aos-duration='1000'>
            ...
            <h4>Instagram</h4>
            <h5>Adarsh6_sharma</h5>
            <a href="https://instagram.com/adarsh6_sharma" target='_blank'  rel="noreferrer">Send a DM</a>
          </article>
