  ...
  return (
   <footer className="footer__container">
    ...
    <div className="footer__socials" data-aos="fade-up" data-aos-anchor=".footer__container"  data-aos-duration='1600'>
      <a href="https://www.linkedin.com/in/adarsh-sharma06/"><BsLinkedin/></a>
      <a href="https://www.instagram.com/adarsh6_sharma/"><BsInstagram/></a>
      <a href="https://github.com/Adarsh-Sharma783"><SiGithub/></a>
    </div>

    <div className="footer__copyright" data-aos="fade-up" data-aos-anchor=".footer__container"  data-aos-duration='1800'>
      <small>&copy; Adarsh Sharma. All rights reserved</small>
    </div>
   </footer>
  )
}
